...
/** initialize a Hessian call with a remote method name.
  * eg. If the remote method has the following signature: public java.lang.Object
...
/** initialze a Hessian call with a remote method name in addition to specifying the major and minor
  version of the Hessian protocol.
  * @param aMethodName is an NSString with the name of the remote method.
    @param majorProtocolVersion is the major number of the protocol. Currently 1.0 and 2.0 are
  support as 0x01 and 0x02 respectively.
    @param minorProtocolVersion is the minor number of the protocol. Currently this is always 0 or
  0x0.
  */
- (id)initWithRemoteMethodName:(NSString *)aMethodName
...
/** Parameters that will be passed to the remote method.
  ...
  * to the remote service. eg [NSArray arrayWithObject:[NSNumber numberWithBool:NO]]; to pass a
 * false bool.
  * @param someParameters should be an NSArray that contains parameters for remote method. Ints,
 * longs, doubles and bools
  * should be passed as NSNumbers. The encoder will handle passing them as their instrinsic types
