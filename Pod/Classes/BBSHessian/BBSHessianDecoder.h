...
/** BBSHessianDecoder is responsible to decoding Hessian binary protocol encoded objects.
  * If class mappings are specified those will also be used to instantiate to appropriate local
 * class instance.
  */
...
/** Static method that decodes an object encoded in Hessian binary protocol and returns the object
 * value.
